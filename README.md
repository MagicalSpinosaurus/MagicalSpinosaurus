...
* **[VISION ROBOT ARM](https://github.com/MagicalSpinosaurus/On-Device-FPGA-based-Vision-Robot-Arm.git)** - BASYS3-based 4-DOF robot arm control system with Vivado Block Design, MicroBlaze, AXI GPIO, Vitis, and custom Verilog servo PWM <br>  **[객체 인식 자동 로봇 팔](https://github.com/MagicalSpinosaurus/On-Device-FPGA-based-Vision-Robot-Arm.git)** - Vivado Block Design, MicroBlaze, AXI GPIO, Vitis, custom Verilog servo PWM 기반 BASYS3 4축 로봇팔 만들기
